...
class Embed_Mol_Prot:
    ...
    def __post_init__(self):
        ...
        self.mol_tokenizer = AutoTokenizer.from_pretrained(self.mol_model_id, trust_remote_code=True, padding='max_length', max_length=64)
        self.protein_model = AutoModel.from_pretrained(self.prot_model_id).to('cuda')
        self.protein_tokenizer = AutoTokenizer.from_pretrained(self.prot_model_id, padding='max_length', max_length=1024)#,  # Pad to 512 tokens)
        self.mol_model.eval()
    ...
    def process_embeddings(
        ...
        mol_inputs = self.mol_tokenizer(smiles_list, padding=True, return_tensors="pt").to('cuda')
        ...
        protein_inputs = self.protein_tokenizer(protein_seq_list, padding=True, return_tensors="pt").to('cuda')
