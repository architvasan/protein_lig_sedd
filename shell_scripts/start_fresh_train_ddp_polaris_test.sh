...
WORK_DIR="${PWD}/experiments/polaris_ddp_4nodes$(date +%Y%m%d_%H%M%S)"
CONFIG_FILE="${PWD}/configs/config_uniref50_ddp_16nodes.yaml"
...
# DDP Configuration
NUM_GPUS=16                    # Number of CUDA devices to use
...
--device "$DEVICE" \
--seed $SEED \
$FRESH_FLAG 2>&1 | tee "$LOG_DIR/polaris_ddp_4nodes_test.log"
